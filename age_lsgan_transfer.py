...
flags.DEFINE_string("source_checkpoint_dir", 'checkpoints/', "Directory name to save the checkpoints")

flags.DEFINE_string("sample_dir", 'sample/' , "Directory name to save the sample images")

flags.DEFINE_string("fea_layer_name", None, "which layer to use for fea_loss")

flags.DEFINE_string("source_file", 'tools/train_all.txt', "source file path")

flags.DEFINE_string("root_folder", 'new_images/', "folder that contains images")
