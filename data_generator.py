...
class ImageDataGenerator:
    def __init__(self, batch_size, height, width, z_dim, shuffle=True,
        ...
        if mode == 'train':
            ...
            self.file_folder = 'tools/test_data/'
...
# using cv2's image read instead of scipy's image read for compatibility with python3
...
def process_target_img(root_folder, img_path, img_size):
    #print("reading image" + root_folder + img_path)
